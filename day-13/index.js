const spaceAge = (seconds) => {
  ...
  yearsInAllPlanets.Mercury = parseFloat(
    (seconds / (totalEarchSec * 0.2408467)).toFixed(2)
  );
  yearsInAllPlanets.Venus = parseFloat(
    (seconds / (totalEarchSec * 0.61519726)).toFixed(2)
  );
  yearsInAllPlanets.Earth = parseFloat((seconds / totalEarchSec).toFixed(2));
  yearsInAllPlanets.Mars = parseFloat(
    (seconds / (totalEarchSec * 1.8808158)).toFixed(2)
  );
  yearsInAllPlanets.Jupiter = parseFloat(
    (seconds / (totalEarchSec * 11.862615)).toFixed(2)
  );
  yearsInAllPlanets.Saturn = parseFloat(
    (seconds / (totalEarchSec * 29.447498)).toFixed(2)
  );
  yearsInAllPlanets.Uranus = parseFloat(
    (seconds / (totalEarchSec * 84.016846)).toFixed(2)
  );
  yearsInAllPlanets.Neptune = parseFloat(
    (seconds / (totalEarchSec * 164.79132)).toFixed(2)
  );
